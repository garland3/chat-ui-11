...
def json_to_pptx(
    ...
    image_filename: Annotated[
        str, "Optional image filename to integrate into the presentation"
    ] = "",
    image_data_base64: Annotated[
        str, "Framework may supply Base64 image content as fallback"
    ] = "",
) -> Dict[str, Any]:
    """
        ...
        <div class="slide-content">"""
            ...
            return {
                ...
                "meta_data": {
                    ...
                    "output_files": ["presentation.pptx", "presentation.html"]
                    if html_b64
                    else ["presentation.pptx"],
                    "output_file_paths": [
                        "temp:output_presentation.pptx",
                        "temp:output_presentation.html",
                    ]
                    if html_b64
                    else ["temp:output_presentation.pptx"],
                },
            }
    except Exception as e:
        if VERBOSE:
