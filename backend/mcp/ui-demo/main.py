...
def create_data_visualization() -> Dict[str, Any]:
    ...
    """
    custom_html = """
    <div style="background: #2d3748; padding: 20px; border-radius: 10px; color: white;">
        ...
        <div style="margin: 20px 0;">
            <div style="margin-bottom: 10px;">
                ...
                <div style="background: #1a202c; height: 30px; border-radius: 15px; position: relative; margin-top: 5px;">
                    <div style="background: linear-gradient(90deg, #4299e1, #63b3ed); 
                                height: 100%; 
                                width: 75%; 
                                border-radius: 15px; 
                                display: flex; 
            ...
            <div style="margin-bottom: 10px;">
                ...
                <div style="background: #1a202c; height: 30px; border-radius: 15px; position: relative; margin-top: 5px;">
                    <div style="background: linear-gradient(90deg, #48bb78, #68d391); 
                                height: 100%; 
                                width: 92%; 
                                border-radius: 15px; 
                                display: flex; 
            ...
            <div style="margin-bottom: 10px;">
                ...
                <div style="background: #1a202c; height: 30px; border-radius: 15px; position: relative; margin-top: 5px;">
                    <div style="background: linear-gradient(90deg, #ed8936, #f6ad55); 
                                height: 100%; 
                                width: 58%; 
                                border-radius: 15px; 
                                display: flex; 
...
def create_form_demo() -> Dict[str, Any]:
    ...
    """
    custom_html = """
    <div style="background: #1a202c; padding: 25px; border-radius: 12px; color: white; max-width: 500px;">
        <h3 style="color: #63b3ed; margin-top: 0; text-align: center;">📋 Interactive Form Demo</h3>
        
        <form onsubmit="event.preventDefault(); alert('Form submitted! Data: ' + JSON.stringify({name: this.name.value, email: this.email.value, message: this.message.value}));" 
