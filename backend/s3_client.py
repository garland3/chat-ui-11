...
class S3StorageClient:
    ...
    def __init__(self):
        ...
        self.config = config_manager.app_settings
        self.base_url = self.config.s3_endpoint
        self.timeout = self.config.s3_timeout
        
        # For mock service, we'll use the user email as the bearer token
        self.use_mock = self.config.s3_use_mock
