...
def test_tool_caller_filters_by_selected_tool_map():
    ...
    tool_calc = Mock()
    tool_calc.to_openai_schema.return_value = make_tool_schema("calculator_evaluate")
    tool_fs_list = Mock()
    tool_fs_list.to_openai_schema.return_value = make_tool_schema("filesystem_list")
    tool_fs_read = Mock()
    tool_fs_read.to_openai_schema.return_value = make_tool_schema("filesystem_read")
    mock_mcp.get_tools_for_servers.return_value = [
        tool_calc,
        tool_fs_list,
        tool_fs_read,
    ]
