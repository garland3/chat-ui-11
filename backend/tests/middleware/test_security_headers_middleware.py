...
class MockAppSettings:
    ...
    def __init__(self, **kwargs):
        ...
        self.security_referrer_policy_enabled = kwargs.get('security_referrer_policy_enabled', True)
        self.security_referrer_policy_value = kwargs.get('security_referrer_policy_value', 'no-referrer')
...
class TestSecurityHeadersMiddleware:
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_all_headers_enabled_default(self, mock_config_manager, mock_app, mock_request, mock_call_next, mock_response):
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_custom_header_values(self, mock_config_manager, mock_app, mock_request, mock_call_next, mock_response):
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_nosniff_disabled(self, mock_config_manager, mock_app, mock_request, mock_call_next, mock_response):
        """Test X-Content-Type-Options header is not set when disabled."""
        mock_config_manager.app_settings = MockAppSettings(security_nosniff_enabled=False)
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_xfo_disabled(self, mock_config_manager, mock_app, mock_request, mock_call_next, mock_response):
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_referrer_policy_disabled(self, mock_config_manager, mock_app, mock_request, mock_call_next, mock_response):
        """Test Referrer-Policy header is not set when disabled."""
        mock_config_manager.app_settings = MockAppSettings(security_referrer_policy_enabled=False)
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_csp_disabled(self, mock_config_manager, mock_app, mock_request, mock_call_next, mock_response):
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_csp_empty_value(self, mock_config_manager, mock_app, mock_request, mock_call_next, mock_response):
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_csp_none_value(self, mock_config_manager, mock_app, mock_request, mock_call_next, mock_response):
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_existing_headers_not_overwritten(self, mock_config_manager, mock_app, mock_request, mock_call_next):
        ...
        middleware = SecurityHeadersMiddleware(mock_app)
        result = await middleware.dispatch(mock_request, call_next_with_existing_headers)
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_partial_existing_headers(self, mock_config_manager, mock_app, mock_request, mock_call_next):
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_all_headers_disabled(self, mock_config_manager, mock_app, mock_request, mock_call_next, mock_response):
    ...
    @patch('middleware.security_headers_middleware.config_manager')
    @pytest.mark.asyncio
    async def test_getattr_fallbacks(self, mock_config_manager, mock_app, mock_request, mock_call_next, mock_response):
