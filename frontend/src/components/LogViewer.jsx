...
import { X, Filter, ChevronDown, ChevronUp, ToggleLeft, ToggleRight, Search } from 'lucide-react';
...
export default function LogViewer() {
  ...
  const [searchQuery, setSearchQuery] = useState(''); // Search query for filtering logs
  const [searchCollapsed, setSearchCollapsed] = useState(false); // State for collapsing search form
  ...
  const filtered = entries.filter(e => {
    // Text search filter (searches across message, module, function, and logger fields)
    if (searchQuery.trim() !== '') {
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
        ...
        <div className="flex items-center justify-between p-4 pb-3">
          <button 
            ...
            className="flex items-center gap-2 hover:bg-blue-100 dark:hover:bg-blue-800/30 rounded-lg px-2 py-1 transition-colors"
          >
            <Search className="w-4 h-4 text-blue-600 dark:text-blue-400" />
            <h3 className="text-sm font-semibold text-blue-700 dark:text-blue-300">Search Logs</h3>
            {searchCollapsed ? (
            ...
            <div className="flex gap-2 items-center">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  placeholder="Search across message, module, function, logger, and level..."
